...
# with open("data/review.txt", "r", encoding="tuf-8") as f:
#     print(f.read())

# readline() : 줄 단위로 읽어오기
# with open("data/review.txt", "r", encoding="utf-8") as f:
#     # print(f.readline())  # 줄 단위로 읽어오기
#     line = f.readline()
#     while line:
#         print(line, end="")
#         line = f.readline()
...
# 결과 bmi 지수가 25이상이면 과체중, 18.5 이상이면 정상체중, 나머지는 저체중
