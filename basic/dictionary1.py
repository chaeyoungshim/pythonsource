...
# get() : key 로 value 가져오기
print(dict1["age"])
print(dict1.get("age"))
print(dict1.get("addr"))  # None => 에러 나오지 않는 효과

# in : 해당 key 가 딕셔너리 안에 있는지 조사
print("name" in dict1)
print(4 in dict2)
print("rank" in dict3)
...
print()
# 실습
# 딕셔너리 dict1 을 아래와 같은 조건으로 생성하시오
# 'A':90, 'B':80, 'C':70
dict1 = {"A": 90, "B": 80, "C": 70}

# 작성된 dict1 에서 B 키에 해당하는 값만 출력
print(dict1["B"])  # print(dict1.get("B")) 도 가능
