...
from urllib.request import urlretrieve  # 다운로드 전용 import
...
from selenium.webdriver.common.by import By
from selenium.webdriver.common.keys import Keys
from urllib.request import urlretrieve  # 이게 편함
import time

browser = webdriver.Chrome()
browser.maximize_window()

browser.get("https://www.google.co.kr/imghp?hl=ko&tab=ri&authuser=0&ogbl")
...
while True:
    ...
    if curr_height == prev_height:
        try:
            # 결과 더보기 버튼 찾은 후 클릭
            button = browser.find_element(By.CLASS_NAME, "mye4qd").click()
        except:
            break
